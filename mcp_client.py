...
client = MultiServerMCPClient(
    {
        ...
        "aviationstack": {
            "transport": "stdio", # since it is a local mcp server
            "command": UVX_COMMAND,
            "args": [
                "aviationstack-mcp"
            ],
        ...
        "weather": {
            "transport": "stdio", # since it is local

            # Using the same Python environment that runs app.py.
...
# function to connect to each mcp server and get all available tools
...
# func --> tavily mcp --> tavily search --> result
